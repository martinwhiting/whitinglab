(() => {
  ...
  document.querySelectorAll('[data-animal-slider]').forEach(slider => {
    ...
    let current = 0;
    let startX = null;
    const carouselName = slider.getAttribute('aria-label') || 'carousel';
    ...
    slides.forEach((slide, index) => {
      ...
      dot.setAttribute('aria-label', `Show ${carouselName} slide ${index + 1}`);
